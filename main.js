...
//classes una clase principal donde creo un constructpr y agrego los operadores
class Calculator {
...
equalButton.addEventListener('click', () => {
	if (calculator.itsPossibleToAddOperation == false) {
		...
		calculator.showResultInDisplay(); //implica borrar la operación del display, por eso lo llamo después de guardar la operación
	}
});
